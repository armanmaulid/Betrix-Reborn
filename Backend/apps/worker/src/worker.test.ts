...
describe('Phase 6: Standalone Worker Application Test Suite', () => {
  describe('News Intelligent Categorization & Sentiment Analysis', () => {
    it('should correctly classify Crypto news from extracted tags', () => {
      const tags = NewsTagging.tagArticle('Bitcoin surges past $100k as institutional ETF inflow spikes', 'Crypto market rally');
    ...
    it('should correctly classify Metal & Gold news from extracted tags', () => {
      const tags = NewsTagging.tagArticle('Gold hits new all-time high amid safe-haven demand', 'Precious metals update');
    ...
    it('should correctly classify Energy & Oil news from extracted tags', () => {
      const tags = NewsTagging.tagArticle('OPEC cuts crude output boosting Brent and WTI barrel prices', 'Energy news');
    ...
    it('should correctly classify Forex news from extracted tags', () => {
      const tags = NewsTagging.tagArticle('Federal Reserve Powell signals interest rate pause as dollar strengthens', 'USD FX outlook');
