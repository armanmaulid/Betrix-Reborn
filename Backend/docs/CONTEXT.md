...
| 6 — D1 `better-auth` | 🔵 Phase 0 ✅ Phase 1 ✅ | `d06677f` Phase 0 (env flag + dep + 4 BA tables + stub + DDL doc). `7af3616` Phase 1 (identity schema +updatedAt/image + d1-backfill-accounts.ts). Phase 2-4 pending. See `docs/D1-better-auth-migration-plan.md`. |
