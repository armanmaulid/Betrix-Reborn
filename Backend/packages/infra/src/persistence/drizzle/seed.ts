...
export const DEFAULT_SYMBOLS = [
  ...
  // Forex Crosses
  {
    ...
    path: 'Forex/Crosses/GBPJPY',
    category: 'forex',
    finnhubSymbol: 'OANDA:GBP_JPY',
    dukascopySymbol: 'gbpjpy',
    isActive: true
  },
  {
    symbol: 'EURJPY',
    description: 'Euro / Japanese Yen',
    path: 'Forex/Crosses/EURJPY',
    category: 'forex',
    finnhubSymbol: 'OANDA:EUR_JPY',
    dukascopySymbol: 'eurjpy',
    isActive: true
  },
  {
    symbol: 'EURGBP',
    description: 'Euro / British Pound',
    path: 'Forex/Crosses/EURGBP',
    category: 'forex',
    finnhubSymbol: 'OANDA:EUR_GBP',
    dukascopySymbol: 'eurgbp',
    isActive: true
  },
  {
    symbol: 'EURCHF',
    description: 'Euro / Swiss Franc',
    path: 'Forex/Crosses/EURCHF',
    category: 'forex',
    finnhubSymbol: 'OANDA:EUR_CHF',
    dukascopySymbol: 'eurchf',
    isActive: true
  },
  {
    symbol: 'AUDJPY',
    description: 'Australian Dollar / Japanese Yen',
    path: 'Forex/Crosses/AUDJPY',
    category: 'forex',
    finnhubSymbol: 'OANDA:AUD_JPY',
    dukascopySymbol: 'audjpy',
    isActive: true
  },
  ...
  },
  {
    ...
    path: 'Energy/XBRUSD',
    category: 'energy',
    finnhubSymbol: 'OANDA:BCO_USD',
    dukascopySymbol: 'brentcmdusd',
    isActive: true
  },
  ...
  // Indices
  {
    ...
    path: 'Indices/US500',
    category: 'indices',
    finnhubSymbol: 'OANDA:SPX500_USD',
    dukascopySymbol: 'usa500idxusd',
    isActive: true
  },
  {
    symbol: 'US30',
    ...
    path: 'Indices/US30',
    category: 'indices',
    finnhubSymbol: 'OANDA:US30_USD',
    dukascopySymbol: 'usa30idxusd',
    isActive: true
  },
  {
    symbol: 'NAS100',
    ...
    path: 'Indices/NAS100',
    category: 'indices',
    finnhubSymbol: 'OANDA:NAS100_USD',
    dukascopySymbol: 'usatechidxusd',
    isActive: true
  }
];
...
export const DEFAULT_STREAM_SYMBOLS = [
  ...
  {
    symbol: 'LINKUSD',
    finnhubSymbol: 'BINANCE:LINKUSDT',
    description: 'Chainlink / US Dollar',
    category: 'crypto'
  },
  {
    symbol: 'SOLUSD',
    finnhubSymbol: 'COINBASE:SOL-USD',
    description: 'Solana / US Dollar',
    category: 'crypto'
  },
  {
    symbol: 'XRPUSD',
    finnhubSymbol: 'COINBASE:XRP-USD',
    description: 'XRP / US Dollar',
    category: 'crypto'
  },
  {
    symbol: 'DOTUSD',
    finnhubSymbol: 'COINBASE:DOT-USD',
    description: 'Polkadot / US Dollar',
    category: 'crypto'
  },
  {
    symbol: 'NEARUSD',
    finnhubSymbol: 'COINBASE:NEAR-USD',
...
export const DEFAULT_AGENTS = [
  {
    ...
    systemPrompt:
      'You are Betrix Institutional Market Analyst Pro. Analyze financial markets with deep precision, technical confluence, risk-reward ratios, and structural market context.',
    tier: 'deep',
  ...
  },
  {
    ...
    systemPrompt:
      'You are a high-speed market intelligence assistant providing instant price action insights, key technical levels, and crisp market summaries.',
    tier: 'cheap',
    creditsPer1kTokens: 1,
    maxTokens: 4096,
    temperature: 60,
  ...
  },
  {
    ...
    taskType: 'trade_reasoning',
    systemPrompt:
      'You are an expert technical strategist specializing in indicator synthesis (RSI, ATR, EMAs, Support/Resistance fractals) and breakout setups.',
    tier: 'balanced',
    creditsPer1kTokens: 1,
    maxTokens: 8192,
    temperature: 70,
  ...
  },
  {
    ...
    systemPrompt:
      'You are an institutional macro analyst synthesizing global news catalysts, market sentiment, and macroeconomic themes with technical market structures.',
    tier: 'deep',
    creditsPer1kTokens: 1,
    maxTokens: 8192,
    temperature: 70,
...
export async function seedAdmin(connectionString?: string) {
  ...
  if (process.env.ADMIN_PASSWORD) {
    ...
    console.log(
      `Seeded administrator: ${email} / ${password} (generated — save it now, shown once)`
    );
  }
  await pool.end();
}
