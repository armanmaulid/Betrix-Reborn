...
export class PromptTemplateRegistry {
  public static readonly PRESETS: Record<string, PromptTemplate> = {
    ...
    market_analysis: {
      ...
      description:
        'Analyzes provided OHLC indicators, support/resistance levels, and market momentum.',
    ...
    news_analysis: {
      ...
      description:
        'Synthesizes market news headlines into fundamental catalysts and sentiment drivers.',
    ...
    risk_assessment: {
      ...
      description:
        'Calculates risk-to-reward metrics, invalidation points, and volatility exposure.',
