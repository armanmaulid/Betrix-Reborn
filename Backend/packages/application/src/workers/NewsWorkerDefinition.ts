...
export const NewsWorkerDefinition: IWorkerDefinition = {
  ...
  category: 'news',
  description: 'Periodically polls global market, forex, and crypto news from Finnhub REST API, tags articles with semantic market tags, and broadcasts via SSE stream.',
  interval: '10s',
