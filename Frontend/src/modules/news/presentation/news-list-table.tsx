      ...
      <table className="w-full text-left text-xs border-collapse font-mono">
        <thead>
          <tr className="border-b border-border bg-black/80 text-[10px] text-muted-foreground uppercase tracking-wider">
            ...
            <th className="p-3 min-w-[320px]">HEADLINE & PREVIEW</th>
          ...
          {isLoading ? (
            <tr>
              <td colSpan={6} className="p-8 text-center text-muted-foreground animate-pulse">
                RETRIEVING LIVE FINANCIAL NEWS TELEMETRY...
              </td>
            </tr>
          ) : isError ? (
            <tr>
            ...
            <tr>
              <td colSpan={6} className="p-8 text-center text-muted-foreground">
                NO NEWS ARTICLES MATCHING YOUR CURRENT FILTERS.
              </td>
            </tr>
          ) : (
            articles.map((article) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Category */}
                  <td className="p-3 whitespace-nowrap">
                    <span className="text-[10px] uppercase font-bold text-muted-foreground border border-border bg-black px-1.5 py-0.5">
                      {article.category}
                    </span>
                  </td>
