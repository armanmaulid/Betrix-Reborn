...
import { CreateAdminUserSchema, type CreateAdminUserInput } from '@/modules/operations/application/schemas/admin.schema';
        ...
        {generatedPassword ? (
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="border border-accent/40 bg-black p-3 flex items-center justify-between gap-2">
              ...
              >
                {isCopied('password') ? <Check className="w-4 h-4 text-positive" /> : <Copy className="w-4 h-4" />}
              </button>
            </div>
